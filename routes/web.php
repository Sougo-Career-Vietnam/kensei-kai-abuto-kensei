...
Route::get('/workplace', [ContentController::class, 'show'])->defaults('path', 'workplace')->name('workplace');
Route::get('/webregist', [ContentController::class, 'show'])->defaults('path', 'webregist')->name('webregist');
Route::get('/contents4', [ContentController::class, 'show'])->defaults('path', 'contents4')->name('contents4');
Route::get('/contents5', [ContentController::class, 'show'])->defaults('path', 'contents5')->name('contents5');
Route::get('/contents6', [ContentController::class, 'show'])->defaults('path', 'contents6')->name('contents6');
