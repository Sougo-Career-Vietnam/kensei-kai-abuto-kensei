...
<div class="tabLink">
  <div class="navItem navItemBg navItemEntry">
    <div class="navItemFlex">
      <div class="js-clickitem">  
        
        <span class="">職場見学会</span> <a href="{{Route('webregist')}}"></a> </div>
        
    </div>
  </div>
  <div class="navItem navItemBg navItemSearch">
    <div class="navItemFlex">
      <div class="js-clickitem">
        
  
        <span class="">求人検索</span> <a href="{{Route('search')}}"></a> </div>
    </div>
  </div>
</div>
