                      ...
                      <div class="title-block flex">
                          <dl class="dl-number">
                              <dt class="dt-number flex">
                                  ...
                                  <p class="text-dt">研修や勉強会など<br>未経験の方でも安心のフォロー体制</p>
                              </dt>
                              <dd class="dd-number">
                       ...
                       <ul class="list-reason flex">
                        ...
                        <div class="box-meassge">
                            ...
                            <div class="text-content">
                              ...
                              <p class="text">
                                私は5年前に技能実習生としてベトナムから来ました。施設から多くのサポートを受け日本語能力検定のN3、N2を取得することができました。特定技能1号で継続して働いています。実務者研修の取得を経て今は2025年の1月の介護福祉士の受験に向けて受験対策の研修を受講中です。こうしたサポートは介護の仕事にやりがいを感じ努力を続ける大きな励みとなっています。
                              </p>
                  ...
                  <div class="inner-reason">
                      ...
                      <div class="box-meassge">
                            ...
                            <div class="text-content">
                              ...
                              <p class="text">
                                私は他職種からあぶと健生苑に転職しました。以前は介護職員の給料は安いと言われていましたが、各種手当や昇給制度等により安定した収入がありました。未経験からでもきちんと指導してもらえ不安なく安心して仕事に専念できています。資格を取得するとそれに見合った給料がいただけるのでやりがいにもなっています。
                              </p>
